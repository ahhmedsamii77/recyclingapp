...
export const deleteTransactionSchema = {
  params: z.object({
    transactionId: z.string().refine((val) => Types.ObjectId.isValid(val), {
      message: "Invalid transaction id",
    }),
  }),
}

export const deleteConversionsSchema = {
  params: z.object({
    conversionId: z.string().refine((val) => Types.ObjectId.isValid(val), {
